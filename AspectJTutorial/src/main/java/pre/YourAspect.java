...
public class YourAspect {
    ...
    * The pointcut will look for the @pre.YourAnnotation
    */
    @Pointcut("@annotation(pre.YourAnnotation)")
    ...
    */
    ...
    /**
    * Defines a pointcut where the @pre.YourAnnotation exists
    * and combines that with a catch-all pointcut with the scope of execution
    */
    @Around("@annotation(pre.YourAnnotation) && execution(* *(..))")
    /**
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            System.out.println("pre.YourAspect's aroundAdvice's body is now executed Before yourMethodAround is called.");
            ...
            System.out.println("pre.YourAspect's aroundAdvice's body is now executed After yourMethodAround is called.");
        }
        return returnObject;
    }
